...
//            textView.setTextColor(context.getResources().getColor(setRandomColor()));
            show(SHOW_TEXT);
        }
    }

//    private int setRandomLogo() {
//        try {
//            @SuppressLint("Recycle")
//            final TypedArray imgs = getResources().obtainTypedArray(R.array.randomarray);
...
//        try {
//            @SuppressLint("Recycle")
//            final TypedArray color = getResources().obtainTypedArray(R.array.random_textcolor_array);
//            final Random random = new Random();
//            final int rndInt = random.nextInt(color.length());
//            return color.getResourceId(rndInt, 0);
//        } catch (Exception e) {
//            e.getStackTrace();
//            return R.drawable.bg_default_company_logo;
//        }
//    }
     ...
     * @param isCircular
     */
    private void setImageStyle(Bitmap bitmap, boolean isCircular) {
        RoundedBitmapDrawable circularBitmapDrawable =
                RoundedBitmapDrawableFactory.create(getContext().getResources(), bitmap);
        circularBitmapDrawable.setCircular(isCircular);
        imageView.setScaleType(isCircular ? ImageView.ScaleType.CENTER_CROP : ImageView.ScaleType.CENTER_INSIDE);
